...
router.get('/plans/department', authMiddleware_1.authenticateToken, (0, authMiddleware_1.checkRole)([Role_1.RoleType.DEPARTMENT_HEAD, Role_1.RoleType.SYSTEM_ADMIN, Role_1.RoleType.HR_STAFF]), (req, res) => PerformanceController_1.performanceController.getDepartmentPlans(req, res));
...
router.get('/reviews/department/:planId', authMiddleware_1.authenticateToken, (0, authMiddleware_1.checkRole)([Role_1.RoleType.DEPARTMENT_HEAD, Role_1.RoleType.SYSTEM_ADMIN, Role_1.RoleType.HR_STAFF]), (req, res) => PerformanceController_1.performanceController.getDepartmentReviews(req, res));
...
router.put('/plans/:id', authMiddleware_1.authenticateToken, (0, authMiddleware_1.checkRole)([Role_1.RoleType.HR_STAFF, Role_1.RoleType.SYSTEM_ADMIN]), (req, res) => PerformanceController_1.performanceController.updatePlan(req, res));
// Update performance review - Only department managers, HR staff and system admin can update
router.put('/reviews/:id', authMiddleware_1.authenticateToken, (0, authMiddleware_1.checkRole)([Role_1.RoleType.DEPARTMENT_HEAD, Role_1.RoleType.HR_STAFF, Role_1.RoleType.SYSTEM_ADMIN]), (req, res) => PerformanceController_1.performanceController.updateReview(req, res));
